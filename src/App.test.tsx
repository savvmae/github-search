...
test('renders error', () => {
  ...
  const error = getByText("We're sorry, something went wrong. Please try again.")
...
test('renders no results text', () => {
  ...
  const noResults = getByText('No repositories found. Please enter something different.')
